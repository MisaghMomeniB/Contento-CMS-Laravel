          ...
          <li class="group relative">
            ...
            <ul
              ...
              <li><a href="{{route("admin.users.index")}}" class="transition block px-4 py-2 hover:bg-gray-100">لیست
                  مشتریان</a></li>
              <li><a href="{{route("createCustomerGenuine")}}" class="transition block px-4 py-2 hover:bg-gray-100">ثبت مشتری حقیقی</a></li>
              <li><a href="{{route("createCustomerLegal")}}" class="transition block px-4 py-2 hover:bg-gray-100">ثبت مشتری حقوقی</a></li>
            </ul>
          </li>
