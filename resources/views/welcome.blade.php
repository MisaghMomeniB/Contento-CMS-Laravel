...
<head>
  ...
  <style>
    ...
    .dropdown-submenu .dropdown-item:nth-child(1) { transition-delay: 0.05s; }
    .dropdown-submenu .dropdown-item:nth-child(2) { transition-delay: 0.1s; }
    .dropdown-submenu .dropdown-item:nth-child(3) { transition-delay: 0.15s; }
    .dropdown-submenu .dropdown-item:nth-child(4) { transition-delay: 0.2s; }
