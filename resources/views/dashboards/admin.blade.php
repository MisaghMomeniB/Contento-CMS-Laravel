...
<body class="bg-gray-800 font-sans" dir="rtl">

    <nav class="bg-gray-800 shadow-md py-4 px-6 flex justify-between items-center">
        <h1 class="text-white text-2xl mb-4 font-bold text-gray-800">داشبورد ادمین</h1>
    ...
    <nav class="bg-gray-800 shadow px-6 py-4 flex justify-between items-center">
        <div class="flex gap-4">
            <a href="{{route("admin.products.create")}}"
                class="text-white bg-blue-600 rounded p-4 justify-between hover:bg-blue-700">ثبت محصول</a>
            <a href="{{route("admin.invoices.create")}}"
                class="text-white bg-yellow-600 rounded p-4 justify-between hover:bg-yellow-700">ثبت فاکتور</a>
            <a href="{{route("admin.categories.create")}}"
                class="text-white bg-green-600 rounded p-4 justify-between hover:bg-green-700">ثبت دسته بندی</a>
        </div>
    </nav>
